...
function moveAt(pageX, pageY) {
  document.querySelector(".sidebar").left = pageX;
  document.querySelector(".sidebar").top = pageY;
}

const mouseMoveHandler = (e) => {
  moveAt(e.target.top, e.target.right);
  console.log(e.pageX);
};
...
function moveAt(eventX, eventY) {
  document.querySelector(".sidebar").style.top = eventX;
  document.querySelector(".sidebar").style.right = eventY;
}
...
function Sidebar(props) {
  return (
    <aside
      ...
      style={{
        right: `${props.sideBarPosition[0]}`,
        top: `${props.sideBarPosition[1]}`,
      }}
    >
      <p>최근 본 상품</p>
